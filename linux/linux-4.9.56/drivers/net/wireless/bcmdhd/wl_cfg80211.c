...
#error You should enable 'WL_ENABLE_P2P_IF' or 'WL_CFG80211_P2P_DEV_IF' \
	...
	#error WL_CFG80211_P2P_DEV_IF is not defined !
#endif
...
// u32 wl_dbg_level = WL_DBG_DBG | WL_DBG_ERR | WL_DBG_INFO | WL_DBG_TRACE ; // WL_DBG_ERR @2019.11.1
...
exit:
	...
	if (((event == WLC_E_ASSOC_IND) || (event == WLC_E_REASSOC_IND)) &&
		...
		sinfo.filled = sinfo.assoc_req_ies_len;
		if (!data) {
