...
// int dhd_msg_level = DHD_ERROR_VAL | DHD_DATA_VAL; // DHD_ERROR_VAL @2019.11.1
...
#define COMPILE_DATE_       "2019/10/31"
#define COMPILE_TIME_       "15:10:30"
const char dhd_version[] = "Dongle Host Driver, version " EPI_VERSION_STR
	DHD_COMPILED " on " COMPILE_DATE_ " at " COMPILE_TIME_;
#else
