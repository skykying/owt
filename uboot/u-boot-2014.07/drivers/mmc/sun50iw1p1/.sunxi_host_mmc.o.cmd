cmd_drivers/mmc/sun50iw1p1/sunxi_host_mmc.o := /aosp/brandy/u-boot-2014.07/../gcc-linaro/bin/arm-linux-gnueabi-gcc -Wp,-MD,drivers/mmc/sun50iw1p1/.sunxi_host_mmc.o.d  -nostdinc -isystem /aosp/brandy/gcc-linaro/bin/../lib/gcc/arm-linux-gnueabi/4.6.3/include -Iinclude  -I/aosp/brandy/u-boot-2014.07/arch/arm/include -I/aosp/brandy/u-boot-2014.07/include/openssl -D__KERNEL__ -DCONFIG_SYS_TEXT_BASE=0x4A000000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -march=armv7-a -Werror -mno-unaligned-access -DCONFIG_ARM -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(sunxi_host_mmc)"  -D"KBUILD_MODNAME=KBUILD_STR(sunxi_host_mmc)" -c -o drivers/mmc/sun50iw1p1/sunxi_host_mmc.o drivers/mmc/sun50iw1p1/sunxi_host_mmc.c

source_drivers/mmc/sun50iw1p1/sunxi_host_mmc.o := drivers/mmc/sun50iw1p1/sunxi_host_mmc.c

deps_drivers/mmc/sun50iw1p1/sunxi_host_mmc.o := \
  ...
  /aosp/brandy/u-boot-2014.07/arch/arm/include/asm/arch/platform.h \
  /aosp/brandy/u-boot-2014.07/arch/arm/include/asm/arch/mmc.h \
  /aosp/brandy/u-boot-2014.07/arch/arm/include/asm/arch/timer.h \
  include/malloc.h \
  include/mmc.h \
    $(wildcard include/config/mmc/spi.h) \
  include/sys_config.h \
  drivers/mmc/sun50iw1p1/../mmc_def.h \
  drivers/mmc/sun50iw1p1/../sunxi_mmc.h \
  drivers/mmc/sun50iw1p1/sunxi_host0_2_v4p1.h \
  drivers/mmc/sun50iw1p1/sunxi_host_mmc.h \
    $(wildcard include/config/arch/sun7i.h) \

drivers/mmc/sun50iw1p1/sunxi_host_mmc.o: $(deps_drivers/mmc/sun50iw1p1/sunxi_host_mmc.o)
