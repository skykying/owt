cmd_tools/common/image.o := gcc -Wp,-MD,tools/common/.image.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer   -include /aosp/brandy/u-boot-2014.07/include/libfdt_env.h -idirafterinclude -idirafter/aosp/brandy/u-boot-2014.07/arch/arm/include -idirafter/aosp/brandy/u-boot-2014.07/include/openssl -I/aosp/brandy/u-boot-2014.07/lib/libfdt -I/aosp/brandy/u-boot-2014.07/tools -DCONFIG_SYS_TEXT_BASE=0x4A000000 -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/common/image.o tools/common/image.c
...
deps_tools/common/image.o := \
  ...
  /aosp/brandy/u-boot-2014.07/common/image.c \
